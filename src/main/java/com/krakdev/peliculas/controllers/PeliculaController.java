...
public class PeliculaController {
    ...
    public ResponseEntity<?> crear(@RequestBody Pelicula pelicula) {
        try {
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body("Error al crear la película");
        }
    }
    ...
    public ResponseEntity<?> listar() {
        try {
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body("Error al listar las películas");
        }
    }
        ...
        try {
            ...
            if (pelicula == null) {
                return ResponseEntity.status(HttpStatus.NOT_FOUND)
                        .body("Película con ID " + id + " no encontrada");
            }

            return ResponseEntity.ok(pelicula);
        } catch (Exception e) {
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body("Error al buscar la película");
        }
    }
    ...
    public ResponseEntity<?> actualizar(@PathVariable Long id, @RequestBody Pelicula pelicula) {
        try {
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body("Error al actualizar la película");
        }
    }
    ...
    public ResponseEntity<?> eliminar(@PathVariable Long id) {
        try {
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body("Error al eliminar la película");
        }
    }
    ...
    public ResponseEntity<?> buscarPorGenero(@RequestParam String genero) {
        try {
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body("Error al buscar por género");
        }
    }
